...
<body>
  <form id="form1" runat="server">
    <div class="card-auth">
      ...
      <p class="help">Fill in your details below to get started</p>
      ...
      <asp:Button ID="btnSubmit" runat="server" Text="Create account" CssClass="btn-accent" OnClick="btnSubmit_Click" />
